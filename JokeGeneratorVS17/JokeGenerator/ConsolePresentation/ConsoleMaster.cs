...
namespace JokeGenerator.ConsolePresentation
{
    ...
    internal sealed class ConsoleMaster : IPresentationBehavior
    {
        ...
        /// <summary>
        /// Displays the current joke configuration.
        ...
        {
            _consoleWriter.WriteLine("Something went wrong. ");
            _consoleWriter.WriteLine(appex.Message);
            return 1;
        }

        public int Exception(Exception exception)
        {
            _consoleWriter.WriteLine("Something went wrong. Please try again");
